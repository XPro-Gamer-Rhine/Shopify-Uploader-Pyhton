...
url = "https://"+api_key+":"+password + \
      "@"+store+".myshopify.com/admin/api/2022-01/products.json"

url_delete_all = url + "?fields=id&limit=250&since_id=6952463138999"

product_list_url = url+"?fields=id,variants&limit=200"

inventory_url = "https://"+api_key+":"+password + "@"+store+".myshopify.com/admin/api/2022-01/inventory_items/"
...
def createProduct(product: Product):
    url = "https://"+api_key+":"+password + "@"+store+".myshopify.com/admin/api/2022-01/products.json"
    print(url)
    product_id = pushProduct("create", url, product)
    return product_id


def updateProduct(product: Product, product_id):
    url = "https://"+api_key+":"+password + \
        "@"+store+".myshopify.com/admin/api/2022-01/products/" + \
        str(product_id)+".json"
...
def pushProductToCollection(product_id, collection_id):
    ...
    time.sleep(520/1000)
    url = "https://"+api_key+":"+password + \
        "@"+store+".myshopify.com/admin/api/2022-01/collects.json"
...
def createCustomCollection(title):
    ...
    url = url = "https://"+api_key+":"+password + \
        "@"+store+".myshopify.com/admin/api/2022-01/custom_collections.json"
    ...
    try:
        ...
        if r.status_code == 201:
            print("Collection ID :- "+str(data['custom_collection']['id']))
